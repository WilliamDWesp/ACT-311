...
<div class="col-12 row pt-3 pb-3 m-0 p-0 mb-3 bg-dark text-white">
    <h1>William Wesp MidTerm Part 7</h1>
</div>
...
<div class="container-fluid row">
    ...
    <div class="col-12 row">
        <div class="col-6 row ">
            ...
            <div class="col-12 ">
                <select class="form-control form-control-lg mb-3 d-none" id="selectType" onchange="getTypeData(this)">
                    <option id="bad">Please Select a class type</option>
                </select>
            </div>
...
<script src="/users/wwesp/act311/hmwk/midterm/scripts/js/part7.js"></script>
